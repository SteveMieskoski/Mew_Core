...
const ethUtil = commonRequires.ethUtil
const ethAbi = commonRequires.abi
...
function typedSignatureHash (typedData) {
  const hashBuffer = typedSignatureHashPartOne(typedData)
  return ethUtil.bufferToHex(hashBuffer)
}

function signTypedData (privateKey, msgParams) {
  const msgHash = typedSignatureHashPartOne(msgParams.data)
 ...
 * @returns Buffer
 */
function typedSignatureHashPartOne (typedData) {
